...
export default class TimelineHeader {
  ...
  addBackgroundObjects() {
    const {
 timeAxisBgRenderer, yAxisBgRenderer, canvas, height 
} = this;
    ...
    timeAxisBgRenderer.setUniformGetter(this.createUniformGetter(0, GeneralConfig.THeaderTimeAxisBgDepth, true),);
    ...
    yAxisBgRenderer.setUniformGetter(this.createUniformGetter(0, GeneralConfig.THeaderYAxisBgDepth, true),);
  }
