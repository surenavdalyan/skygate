    ...
    return (
      <div className="modal-container">
        ...
        >
          ...
          <Modal.Body bsClass="modal-body possession-modal modal-body-rowEditing">
          ...
          <Modal.Footer>
            <Button className="btn btn-success" onClick={this.onChangesSave}>Save</Button>
            <Button className="btn btn-default" onClick={this.onChangesCancel}>Cancel</Button>
          </Modal.Footer>
        </Modal>
      </div>
    );
